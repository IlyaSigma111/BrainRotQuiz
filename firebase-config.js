...
// 📚 30 КОРОТКИХ ЗАДАНИЙ ОГЭ 2026 (БЕЗ ТАЙМЕРОВ)
window.QUIZ_DATA = {
    id: "oge_2026_short",
    ...
    questions: [
        // ЗАДАНИЯ 1-10: СИНТАКСИС И ПУНКТУАЦИЯ
        {
            id: 1,
            type: "syntax",
            text: "Найдите грамматическую основу предложения: «Из гнезда вылупляются птенцы».",
            options: [
                "1) вылупляются",
        ...
        },
        {
            id: 2,
            type: "syntax",
            text: "Найдите грамматическую основу предложения: «Птицы начинают петь на рассвете».",
            options: [
                "1) птицы начинают петь",
                "2) начинают петь",
                "3) птицы петь",
                "4) петь на рассвете"
            ],
            correct: 0,
            explanation: "Правильно: 'птицы начинают петь' — так надо крч (лень писать).",
            points: 1,
            difficulty: "easy"
        },
        {
        ...
        },
        {
            ...
            correct: 0,
            explanation: "Очередное, невероятно сложное задание",
            points: 1,
            difficulty: "medium"
        },
        {
        ...
        },
        {
            ...
            correct: 0,
            explanation: "Существительное с предлогом 'в течение' (чего?) дня.",
            points: 1,
            difficulty: "medium"
        },
        {
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Глагол II спряжения: денешься.",
            points: 1,
            difficulty: "medium"
        },
        {
        ...
        },
        {
            ...
            correct: 0,
            explanation: "Да, это очень сложное задание.",
            points: 1,
            difficulty: "medium"
        },
        {
            ...
            correct: 2,
            explanation: "Кто прочитал тот утюг",
            points: 1,
            difficulty: "hard"
        },
        {
        ...
        },
        {
            ...
            correct: 0,
            explanation: "Кто вообще это читает",
            points: 1,
            difficulty: "hard"
        },
        {
            id: 23,
            type: "spelling",
            text: "Как пишется: «не ? свобода человека»?",
            options: [
                "1) несвобода",
                "2) не свобода",
                "3) несвабода",
        ...
        },
        {
            id: 30,
            type: "word_formation",
            text: "Замените словосочетание «дом родителей» на синонимичное со связью согласование.",
            options: [
                "1) родительский дом",
                "2) дом для родителей",
                "3) дом у родителей",
            ...
            correct: 0,
            explanation: "Пепе шнейне ватафа",
            points: 1,
            difficulty: "medium"
        }
    ]
...
console.log(`✅ Загружено ${QUIZ_DATA.questions.length} заданий (без таймеров)`);
