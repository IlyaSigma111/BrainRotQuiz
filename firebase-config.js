...
window.QUIZ_DATA = {
    ...
    version: "2026.1",
    timePerQuestion: 25, // 25 секунд на каждое задание
    questions: [
        {
            id: 1,
            type: "syntax",
            text: "Найдите грамматическую основу: «Из гнезда вылупляются аистята».",
            options: [
                "1) вылупляются",
                "2) вылупляются аистята",
                "3) из гнезда вылупляются",
                "4) аистята вылупляются"
            ],
            correct: 1,
            time: 25,
            explanation: "Правильно: 'вылупляются аистята' — подлежащее + сказуемое.",
            points: 1,
            difficulty: "easy"
        },
        {
            id: 2,
            type: "syntax",
            text: "Найдите грамматическую основу: «Птенцы начинают посматривать на людей».",
            options: [
                "1) птенцы начинают",
                "2) начинают посматривать",
                "3) птенцы посматривать",
                "4) посматривать на людей"
            ],
            correct: 1,
            time: 25,
            explanation: "Правильно: 'птенцы начинают' — составное глагольное сказуемое.",
            points: 1,
            difficulty: "easy"
        },
        {
            ...
            options: [
                "1) Аисты высиживают яйца.",
                "2) Когда птенцы подрастут, они будут смотреть на людей.",
                "3) Аистята ждут родителей и радуются.",
                "4) Люди ценят дружбу с аистами."
            ],
            correct: 1,
            time: 25,
        ...
        },
        {
            id: 4,
            type: "punctuation",
            text: "Где нужно поставить запятую? «Аистята ждут родителей() которые приносят им еду».",
            options: [
                "1) Перед 'которые'",
                "2) Перед 'приносят'",
                "3) Запятая не нужна",
        ...
        },
        {
            id: 5,
            type: "punctuation",
            text: "Где нужна запятая? «Люди ценят аистов() и ждут() когда они поселятся на крышах».",
            options: [
                "1) Обе запятые нужны",
                "2) Только первая",
                "3) Только вторая",
        ...
        },
        {
            id: 6,
            type: "spelling",
            text: "Выберите правильное написание: «Бе..цельный поиск».",
            options: [
                "1) беспцельный",
                "2) бесцельный",
                "3) безцельный",
            ...
            correct: 1,
            time: 25,
            explanation: "Приставка БЕС- перед глухим согласным Ц.",
            points: 1,
            difficulty: "easy"
        },
        {
            id: 7,
            type: "spelling",
            text: "Выберите правильное написание: «В течени.. часа».",
            options: [
                "1) течении",
                "2) течениие",
                "3) течение",
            ...
            correct: 0,
            time: 25,
            explanation: "Существительное с предлогом 'в течении' (чего?) часа.",
            points: 1,
            difficulty: "medium"
        },
        {
            id: 8,
            type: "spelling",
            text: "Как правильно: «Он не должен() этого делать»?",
            options: [
                "1) Недолжен (слитно)",
                "2) Не должен (раздельно)",
                "3) Ни должен",
                "4) Недолжон"
            ],
            correct: 1,
        ...
        },
        {
            id: 9,
            type: "spelling",
            text: "Вставьте букву: «Никуда не ден..шься от зноя».",
            options: [
                "1) е",
                "2) и",
                "3) я",
        ...
        },
        {
            id: 10,
            type: "spelling",
            text: "Вставьте букву: «Воздух колыш..тся над дорогой».",
            options: [
                "1) е",
                "2) и",
                "3) я",
        ...
        },
        {
            id: 13,
            type: "reading",
            text: "Что верно о тексте Бунина? «В доме болел ребёнок, который просил...»",
            options: [
                "1) красные лапти",
                "2) новую игрушку",
                "3) конфеты",
            ...
            correct: 0,
            time: 25,
            explanation: "Ребёнок в бреду просил красные лапти.",
            points: 1,
            difficulty: "easy"
        },
        {
            id: 14,
            type: "reading",
            text: "Что сделал Нефёд в тексте Бунина?",
            options: [
                "1) Пошёл за врачом",
                "2) Пошёл за красными лаптями",
                "3) Остался дома",
                "4) Уехал в город"
            ],
            correct: 1,
            time: 25,
            explanation: "Нефёд пошёл в Новосёлки за красными лаптями.",
            points: 1,
            difficulty: "easy"
        },
        {
            id: 15,
            type: "stylistics",
            text: "Найдите эпитет: «непроглядная вьюга».",
            options: [
                "1) непроглядная",
                "2) вьюга",
                "3) оба слова",
        ...
        },
        {
            id: 16,
            type: "lexicology",
            text: "Что такое «фуксин» в тексте Бунина?",
            options: [
                "1) Краситель",
                "2) Лекарство",
                "3) Еда",
            ...
            correct: 0,
            time: 25,
            explanation: "Фуксин — ярко-красный краситель для лаптей.",
            points: 1,
            difficulty: "medium"
        },
        // Вариант 2 (акварель)
        {
            id: 17,
            type: "syntax",
            text: "Найдите грамматическую основу: «Акварель стали использовать с XV века».",
            options: [
                "1) акварель стали",
                "2) стали использовать",
                "3) акварель использовать",
                "4) использовать с века"
            ],
            correct: 1,
            time: 25,
            explanation: "Правильно: 'акварель стали' — подлежащее + часть сказуемого.",
            points: 1,
            difficulty: "easy"
        },
        {
            id: 18,
            type: "spelling",
            text: "Как правильно: «замир..ть от страха»?",
            options: [
                "1) замиреть",
                "2) замереть",
                "3) замирать",
        ...
        },
        {
            id: 19,
            type: "spelling",
            text: "Как пишется: «комари..ый укус»?",
            options: [
                "1) комариный",
                "2) комаринный",
                "3) комарийный",
        ...
        },
        {
            id: 21,
            type: "reading",
            text: "Что хотели купить мальчики в тексте Круглова?",
            options: [
                "1) Ёлку и игрушки",
                "2) Книги",
                "3) Сладости",
            ...
            correct: 0,
            time: 25,
            explanation: "Мальчики хотели купить ёлку к Рождеству.",
            points: 1,
            difficulty: "easy"
        },
        // Вариант 3 (акробатика)
        {
            id: 22,
            type: "syntax",
            text: "Найдите грамматическую основу: «Акробатика — основа циркового искусства».",
            options: [
                "1) акробатика — основа",
                "2) основа искусства",
                "3) акробатика искусства",
                "4) циркового искусства"
            ],
            correct: 0,
            time: 25,
        ...
        // Вариант 4 (акулы)
        {
            id: 25,
            type: "syntax",
            text: "Найдите грамматическую основу: «Люди не любят акул».",
            options: [
                "1) люди не любят",
                "2) не любят акул",
                "3) люди акул",
            ...
            correct: 0,
            time: 25,
            explanation: "Подлежащее 'люди', сказуемое 'не любят'.",
            points: 1,
            difficulty: "easy"
        },
        {
        ...
        // Вариант 5 (Андерсен)
        {
            id: 28,
            type: "syntax",
            text: "Найдите грамматическую основу: «В сказках Андерсена есть мудрость».",
            options: [
                "1) в сказках есть",
                "2) есть мудрость",
                "3) сказках Андерсена",
            ...
            correct: 1,
            time: 25,
            explanation: "Сказуемое 'есть', подлежащее 'мудрость'.",
            points: 1,
            difficulty: "easy"
        },
        {
...
// 🛠️ СИСТЕМА МОДЕРАТОРОВ (без изменений)
